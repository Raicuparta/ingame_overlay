...
#define SYSTEM_LOOP_NAME_DISABLE_WARNING(warningCode) __pragma(warning(push)) __pragma(warning(disable : warningCode))

#define SYSTEM_LOOP_NAME_RESTORE_WARNINGS() __pragma(warning(pop))
#else
...
#define SYSTEM_LOOP_NAME(name)                                   \
    ...
    {                                                            \
        ...
        SYSTEM_LOOP_NAME_CAT(_namedloop_break_, name)            \
            : break;                                             \
        SYSTEM_LOOP_NAME_CAT(_namedloop_continue_, name)         \
            : continue;                                          \
