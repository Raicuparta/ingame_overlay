...
struct GuidData
{
    ...
    inline constexpr GuidData() noexcept
        : Bytes{}
    {
    }
    inline constexpr GuidData(
        uint32_t dword, uint16_t short1, uint16_t short2, uint16_t short3, uint8_t byte1, uint8_t byte2, uint8_t byte3, uint8_t byte4, uint8_t byte5, uint8_t byte6) noexcept
        : Dword(dword)
        , Short1(short1)
        , Short2(short2)
        , Short3(short3)
...
{
    if (l.Dword != r.Dword)
        return l.Dword < r.Dword;
    if (l.Short1 != r.Short1)
        return l.Short1 < r.Short1;
    if (l.Short2 != r.Short2)
        return l.Short2 < r.Short2;
    if (l.Short3 != r.Short3)
        return l.Short3 < r.Short3;
    if (l.Byte1 != r.Byte1)
        return l.Byte1 < r.Byte1;
    if (l.Byte2 != r.Byte2)
        return l.Byte2 < r.Byte2;
    if (l.Byte3 != r.Byte3)
        return l.Byte3 < r.Byte3;
    if (l.Byte4 != r.Byte4)
        return l.Byte4 < r.Byte4;
    if (l.Byte5 != r.Byte5)
        return l.Byte5 < r.Byte5;
...
class Guid
{
  ...
  public:
    ...
    inline constexpr Guid &operator=(Guid const &other)
    {
        _Data = other._Data;
        return *this;
    }
    inline constexpr Guid &operator=(Guid &&other) noexcept
    {
        _Data = other._Data;
        return *this;
    }
    inline constexpr Guid &operator=(GuidData const &other)
    {
        _Data = other;
        return *this;
    }
    inline constexpr Guid &operator=(GuidData &&other) noexcept
    {
        _Data = other;
        return *this;
    }
